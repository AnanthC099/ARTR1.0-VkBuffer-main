...
VkResult CreateVertexBuffer(void)
{
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() function failed with error code %d for vertexdata_color.vkBuffer\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() succedded vertexdata_color.vkBuffer\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() function failed with error code for %d for vertexdata_color.vkDeviceMemory\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() succedded for vertexdata_color.vkDeviceMemory\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkBindBufferMemory() function failed with error code %d for vertexdata_color.vkBuffer\n", vkResult);
		return vkResult;
	}
	else
	{
