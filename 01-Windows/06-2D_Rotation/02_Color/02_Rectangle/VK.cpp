...
VkResult CreateVertexBuffer(void)
{
	...
	*/
    ...
    /* top‑left    */ 0.0f, 0.0f, 1.0f,
    /* bottom‑left */ 0.0f, 0.0f, 1.0f,
    /* bottom‑right*/ 0.0f, 0.0f, 1.0f,

    /* top‑left    */ 0.0f, 0.0f, 1.0f,
    /* bottom‑right*/ 0.0f, 0.0f, 1.0f,
    /* top‑right   */ 0.0f, 0.0f, 1.0f
	};
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() function failed for vertexdata_position with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() succedded for vertexdata_position\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() function failed for vertexdata_position with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() succedded for vertexdata_position\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkBindBufferMemory() function failed for vertexdata_position with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkBindBufferMemory() succedded for vertexdata_position\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkMapMemory() function failed for vertexdata_position with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkMapMemory() succedded for vertexdata_position\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() function failed for vertexdata_color with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkCreateBuffer() succedded for vertexdata_color\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() function failed for vertexdata_color with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkAllocateMemory() succedded for vertexdata_color\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkBindBufferMemory() function failed for vertexdata_color with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkBindBufferMemory() succedded for vertexdata_color\n");
	}
	...
	*/
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkMapMemory() function failed for vertexdata_color with error code %d\n", vkResult);
		return vkResult;
	}
	else
	{
		fprintf(gFILE, "CreateVertexBuffer(): vkMapMemory() succedded for vertexdata_color\n");
	}
...
VkResult buildCommandBuffers(void)
{
	...
	*/
	for(uint32_t i =0; i< swapchainImageCount; i++)
	{
		...
		*/
		VkBuffer buffers[] = { vertexdata_position.vkBuffer, vertexdata_color.vkBuffer };
		...
		vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 0, 2, buffers, vkDeviceSize_offset_array); //Here recording
