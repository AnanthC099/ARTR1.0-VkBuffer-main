...
VkResult buildCommandBuffers(void)
{
	...
	*/
	for(uint32_t i =0; i< swapchainImageCount; i++)
	{
		...
		*/
		/*
		vkCmdDraw(vkCommandBuffer_array[i], 4, 0, 0, 0);
		vkCmdDraw(vkCommandBuffer_array[i], 4, 4, 0, 0);
		vkCmdDraw(vkCommandBuffer_array[i], 4, 8, 0, 0);
		vkCmdDraw(vkCommandBuffer_array[i], 4, 12, 0, 0);
		vkCmdDraw(vkCommandBuffer_array[i], 4, 16, 0, 0);
		vkCmdDraw(vkCommandBuffer_array[i], 4, 20, 0, 0);
		*/
		for (uint32_t face = 0; face < 6; ++face)
			vkCmdDraw(vkCommandBuffer_array[i], 6, 1, face * 6, 0);
