...
static VkResult CreateLogicalDeviceAndQueue()
{
    ...
    // We don't enable fillModeNonSolid anymore; removing wireframe support
    VkPhysicalDeviceFeatures deviceFeatures{};
    // If you need other device features, set them here.
...
{
    // Prefer 32-bit float or 24-bit with stencil
...
VkResult CreateGraphicsPipeline()
{
    ...
    // ***** REMOVED WIREFRAME: set polygonMode = VK_POLYGON_MODE_FILL *****
    VkPipelineRasterizationStateCreateInfo rasterizer{};
    rasterizer.sType                   = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO;
    rasterizer.polygonMode             = VK_POLYGON_MODE_FILL;  // Solid fill
    rasterizer.cullMode                = VK_CULL_MODE_NONE;     // or VK_CULL_MODE_BACK_BIT if desired
...
void uninitialize(void)
{
    ...
    if (vkDevice) {
        ...
        // Pipeline, descriptor sets, buffers
