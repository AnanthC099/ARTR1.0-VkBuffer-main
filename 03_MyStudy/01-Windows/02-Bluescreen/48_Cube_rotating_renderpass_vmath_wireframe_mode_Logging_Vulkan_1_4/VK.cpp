...
// Globals
// ---------------------------------------------------------------------------
const char* gpszAppName = "Vulkan_3D_Cube_Wireframe";
HWND  ghwnd = NULL;
BOOL  gbActive = FALSE;
DWORD dwStyle = 0;
...
// A wireframe-friendly cube: each face is 2 triangles.
...
static VkResult CreateLogicalDeviceAndQueue()
{
    ...
    if (supportedFeatures.fillModeNonSolid) {
        ...
        fprintf(gFILE, "Device supports fillModeNonSolid (for wireframe)\n");
    }
