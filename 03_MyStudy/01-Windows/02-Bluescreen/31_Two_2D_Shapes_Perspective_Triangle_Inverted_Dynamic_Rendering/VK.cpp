/*
    ...
    - Added verbose logging for each major step and sub-step of Vulkan initialization.
    - Modified vertex data to include 2 shapes (triangle + square) and made 2 draw calls.
*/
...
// ----------------------------------------------------------------
// Instead of only 3 vertices for a single triangle, we define 
// 9 vertices total: 
//   - 3 for the left triangle
//   - 6 for the right square (2 triangles).
// ----------------------------------------------------------------
...
static VkResult CreateLogicalDeviceAndQueue()
{
    ...
    // If on Vulkan 1.2 or older, need the feature struct
...
VkResult CreateVertexBuffer()
{
    ...
    // Now we have 9 vertices total in gVertices.
...
void UpdateUniformBuffer()
{
    ...
    // We have removed "proj[1][1] *= -1.0f;" to avoid upside-down flipping.
