...
{
    // We need the surface/Win32 surface
...
static VkResult FillDeviceExtensionNames()
{
    ...
    if (foundDynRender) {
        ...
        fprintf(gFILE, "[LOG] 'VK_KHR_dynamic_rendering' not found, hoping Vulkan 1.3 is core.\n");
    }
    fflush(gFILE);
...
static VkResult CreateLogicalDeviceAndQueue()
{
    ...
    fprintf(gFILE, "vkCreateDevice() succeeded, queue retrieved.\n");
    fflush(gFILE);
    return VK_SUCCESS;
}
...
VkResult buildCommandBuffers()
{
    ...
    fprintf(gFILE, "Command buffers built with layout transitions.\n");
    fflush(gFILE);
    return VK_SUCCESS;
}
