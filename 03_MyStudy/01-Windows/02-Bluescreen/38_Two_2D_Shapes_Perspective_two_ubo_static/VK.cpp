...
// Combined vertex data: a left triangle (3 vertices) + right square (6 vertices)
...
VkResult CreateGraphicsPipeline()
{
    ...
    pipelineInfo.renderPass          = gRenderPass;  // <--- important
...
void UpdateTriangleUniformBuffer()
{
    ...
    // Increase angle each frame (triangle speed)
    angleTriangle += 0.5f; 
...
void UpdateSquareUniformBuffer()
{
    ...
    // Increase angle each frame (square speed)
    angleSquare += 0.1f;
